...
public class UpdateAsyncTest : ExperimentalRepositoryCollectionBaseTestBase
{
    ...
    public async Task BasicWithFilterForDisk()
    {
        //Arrange
        ...
        var sut = await GetCollection(CollectionType.Disk) as IDiskRepositoryCollection<TestEntity, ObjectId>;
